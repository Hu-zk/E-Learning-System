        ...
        <div className="email-section">
            ...
            {selectedTemplate === "welcomeTeacher" && (
                <div className="email-template">
                    <h3>Welcome to Our Learning System, {name}!</h3> <br />
                    <p>Dear {name},</p> <br />
                    ...
                    <ul>
                        <li>Email: {name}@elearning.com</li>
                        <li>Password: {name}teacher2023</li> <br />
                    </ul>
            ...
            {selectedTemplate === "welcomeStudent" && (
                <div className="email-template">
                    ...
                    <ul> <br />
                        <li>Email: {name}@elearning.com</li>
                        <li>Password: {name}student2023</li> <br />
                    </ul>
